...
[Link to Google Slides Portion of Presentation](https://docs.google.com/presentation/d/1enng_qr95KrJKR760wzB6u-KmlCtViqBboM_zHF_BBg/edit?slide=id.g4dfce81f19_0_45#slide=id.g4dfce81f19_0_45)
...
p_bubble1 <- ggplot(data, aes(
    x = GraduationRates, y = ViolentRate, size = PovertyRate,
    color = Region, text = hover_txt1
)) +
    geom_point(alpha = 0.7, shape = 16) +
    scale_size(range = c(1, 10), name = "Poverty Rate", guide = "none") +
    theme_minimal() +
    labs(y = "Violent Crime Rates", x = "CCMR Graduates", title = "Violent Crime vs Graduation Rates (Size = Poverty)") +
...
p_bubble2 <- ggplot(data, aes(
    x = CCMR.Grads, y = PropertyRate, size = MobilityRate,
    color = Region, text = hover_txt2
)) +
    geom_point(alpha = 0.7, shape = 16) +
    scale_size(range = c(1, 10), name = "Mobility Rate", guide = "none") +
    theme_minimal() +
    labs(y = "Property Crime Rate", x = "CCMR Graduates Rate", title = "Property Crime vs CCMR Grads (Size = Mobility)") +
    theme(text = element_text(family = font_family), legend.position = "none")
...
### Bubble Chart 3
p_bubble3 <- ggplot(data, aes(
    x = CCMR.College, y = PropertyRate, size = heterogeneity6,
    color = Region, text = hover_txt3
)) +
    geom_point(alpha = 0.7, shape = 16) +
    scale_size(range = c(1, 10), name = "Heterogeneity Index", guide = "none") +
    theme_minimal() +
    labs(y = "Property Crime Rate", x = "CCMR College-Ready Rate", title = "Property Crime vs CCMR College-Ready Grads (Size = Heterogeneity Index)") +
    theme(text = element_text(family = font_family), legend.position = "none")

ggplotly(p_bubble3, tooltip = "text") %>% 
  layout(legend = list(x = 0.75, y = 1))
